        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatOwnerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatInvitation", x => new { x.SenderId, x.ReceiverId, x.ChatId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatParticipants", x => new { x.ChatUsersId, x.ChatsId });
                    table.ForeignKey(
                        name: "FK_ChatParticipants_AspNetUsers_ChatUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatParticipants_ChatsId",
